...
ActiveRecord::Schema.define(:version => 20121211032307) do
  ...
  create_table "team_dues", :force => true do |t|
    t.integer  "year"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
    t.integer  "student_id"
  ...
  create_table "trip_deposits", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
    t.integer  "student_id"
    t.integer  "trip_id"
  ...
  create_table "trip_fees", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
    t.integer  "student_id"
    t.integer  "trip_id"
  ...
  create_table "trips", :force => true do |t|
    ...
    t.boolean  "requires_trip_deposit"
    t.boolean  "requires_trip_fee"
  end
