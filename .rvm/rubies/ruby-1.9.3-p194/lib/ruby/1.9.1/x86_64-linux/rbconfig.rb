...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/stuy/.rvm/rubies/ruby-1.9.3-p194")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/stuy/.rvm/rubies/ruby-1.9.3-p194' '--enable-shared' '--disable-install-doc' '--with-libyaml' '--with-opt-dir=/home/stuy/.rvm/usr'"
